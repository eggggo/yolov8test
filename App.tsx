...
const OUTPUT_TENSOR_WIDTH = 800;
const OUTPUT_TENSOR_HEIGHT = 800;
...
export default function App() {
  ...
  const handleCameraStream = async (
    ...
    const loop = async () => {
      ...
      const imgTensor2 = imageTensor.asType('float32')
      const imgTensor3 = imgTensor2.expandDims(0);
      const startTs = Date.now();
      const preds = await model!.predict(
        imgTensor3
      );
      //post process
      ...
      tf.dispose([imageTensor, imgTensor2, imgTensor3, preds]);
